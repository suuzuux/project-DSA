...
(function () {
  ...
  /* 스케줄 원본 — 알림·미니캘린더·주간 그리드가 전부 여기를 본다 */
  var EVENTS_BY_DATE = {
    "2026-08-03": [
      {
        id: "riize-mbk-682",
        ...
        title: {
          ko: "KBS 뮤직뱅크 (682회)",
          en: "KBS Music Bank (Ep.682)",
          ja: "KBS ミュージックバンク (682回)",
          zh: "KBS 音乐银行 (第682期)",
          fr: "KBS Music Bank (Ép.682)",
          es: "KBS Music Bank (Ep.682)",
        },
      },
    ],
    "2026-08-07": [
      {
        ...
        place: "온라인",
        title: {
          ko: "CORTIS 브이라이브 - 비하인드",
          en: "CORTIS V Live - Behind",
          ja: "CORTIS Vライブ - ビハインド",
          zh: "CORTIS V直播 - 幕后",
          fr: "CORTIS V Live - Coulisses",
          es: "CORTIS V Live - Detrás de cámaras",
        },
      },
    ],
    "2026-08-10": [
      {
        ...
        time: "20:00",
        place: "인터파크 티켓",
        link: "https://ticket.interpark.com",
        title: {
          ko: "2026 WORLD TOUR 티켓 오픈",
          en: "2026 World Tour ticket open",
          ja: "2026 WORLD TOUR チケットオープン",
          zh: "2026世界巡演开票",
          fr: "Ouverture billetterie World Tour 2026",
          es: "Apertura de venta World Tour 2026",
        },
      },
    ],
    "2026-08-14": [
      {
        ...
        hasTicketImage: true,
        title: {
          ko: "2026 WORLD TOUR - BUSAN",
          en: "2026 World Tour - Busan",
          ja: "2026 WORLD TOUR - 釜山",
          zh: "2026世界巡演 - 釜山",
          fr: "World Tour 2026 - Busan",
          es: "World Tour 2026 - Busan",
        },
      },
    ],
    "2026-08-17": [
      {
        ...
        title: {
          ko: "MBC 쇼! 음악중심",
          en: "MBC Show! Music Core",
          ja: "MBC ショー！音楽中心",
          zh: "MBC音乐中心",
          fr: "MBC Show! Music Core",
          es: "MBC Show! Music Core",
        },
      },
      {
        id: "riize-riizing",
        ...
        place: "YouTube",
        title: {
          ko: "RIIZING DAY ep.34",
          en: "RIIZING DAY ep.34",
          ja: "RIIZING DAY ep.34",
          zh: "RIIZING DAY ep.34",
          fr: "RIIZING DAY ep.34",
          es: "RIIZING DAY ep.34",
        },
      },
    ],
    "2026-08-21": [
    ...
    "2026-08-24": [
      {
        ...
        title: {
          ko: "RIIZE 멤버십 전용 라이브",
          en: "RIIZE Membership-only Live",
          ja: "RIIZE メンバーシップ限定ライブ",
          zh: "RIIZE 会员专属直播",
          fr: "Live réservé aux membres RIIZE",
          es: "Live exclusivo para miembros RIIZE",
        },
      },
    ],
  };
  ...
  var EXTRA_NOTIFICATIONS = [
    {
      ...
      read: true,
      eventId: null,
      time: { ko: "어제", en: "Yesterday", ja: "昨日", zh: "昨天", fr: "Hier", es: "Ayer" },
      title: { ko: "새 게시글 등록", en: "New post", ja: "新しい投稿", zh: "新帖子", fr: "Nouveau post", es: "Nueva publicación" },
      message: {
        ko: "RIIZE 원빈님이 새 게시글을 남겼어요: \"오늘 뮤뱅 무대 재밌었어!\"",
        en: "RIIZE's Wonbin posted: \"The Music Bank stage was so fun today!\"",
        ja: "RIIZEのウォンビンさんが新しい投稿をしました：「今日のミューバンステージ楽しかった！」",
        zh: "RIIZE 的元彬发布了新帖子：《今天音银舞台超好玩！》",
        fr: "Wonbin de RIIZE a publié : « La scène Music Bank était trop cool aujourd'hui ! »",
        es: "Wonbin de RIIZE publicó: “¡El escenario de Music Bank estuvo genial hoy!”",
      },
    },
    {
      id: "media-teaser",
      ...
      read: true,
      eventId: null,
      time: { ko: "2일 전", en: "2 days ago", ja: "2日前", zh: "2天前", fr: "il y a 2 j", es: "hace 2 días" },
      title: { ko: "새 미디어 등록", en: "New media", ja: "新しいメディア", zh: "新媒体", fr: "Nouveau média", es: "Nuevo contenido" },
      message: {
        ko: "'Do your dance' Teaser 영상이 업로드되었습니다.",
        en: "'Do your dance' teaser video has been uploaded.",
        ja: "「Do your dance」ティザー映像がアップロードされました。",
        zh: "《Do your dance》预告片已上传。",
        fr: "La vidéo teaser « Do your dance » a été mise en ligne.",
        es: "Se subió el video teaser de 'Do your dance'.",
      },
    },
  ];
  ...
  function notificationsFromSchedule() {
    var items = [];
    var typeMap = { live: "live_start", ticket_open: "ticket_d1", concert: "concert_day", broadcast: "broadcast" };
  ...
  function allNotifications() {
    ...
    var merged = notificationsFromSchedule().concat(EXTRA_NOTIFICATIONS);
  ...
  function renderNotiPanel() {
    ...
    document.querySelectorAll(".wp-noti-panel").forEach(function (panel) {
      var body = list.length
        ? list.map(function (n) {
            var open = state.expandedId === n.id;
            var icon = NOTI_ICON[n.type] || "🔔";
            var timeLabel = n.date ? relativeTime(n.date) : tr(n.time);
            return (
              '<div class="wp-noti-item' + (open ? " is-open" : "") + (n.read ? " is-read" : "") + '" data-noti-id="' + esc(n.id) + '">' +
                '<button type="button" class="wp-noti-item__head" data-noti-toggle="' + esc(n.id) + '">' +
                  '<span class="wp-noti-item__icon">' + icon + "</span>" +
                  '<span class="wp-noti-item__meta">' +
                    '<span class="wp-noti-item__title">' + esc(tr(n.title)) +
                      (n.read ? "" : '<span class="wp-noti-item__dot"></span>') +
                    "</span>" +
                    '<span class="wp-noti-item__time">' + esc(timeLabel) + "</span>" +
                    (open ? "" : '<span class="wp-noti-item__preview">' + esc(tr(n.message)) + "</span>") +
                  "</span>" +
                "</button>" +
                (open
                  ? '<div class="wp-noti-item__body">' + esc(tr(n.message)) +
                      (n.eventId
                        ? '<button type="button" class="wp-noti-item__cal" data-open-event="' + esc(n.eventId) + '">📅 ' + esc(ui.calendarTitle) + "</button>"
                        : "") +
                    "</div>"
                  : "") +
              "</div>"
  ...
  function updateNotiBadges() {
    ...
    document.querySelectorAll(".wp-noti-bound").forEach(function (btn) {
      btn.classList.toggle("icon-btn--badge", unread > 0);
    });
  }
  ...
  function markAllRead() {
    saveReadIds(allNotifications().map(function (n) { return n.id; }));
    renderNotiPanel();
    updateNotiBadges();
  }
  ...
  function hydrateMiniCal() {
    ...
    for (i = 1; i <= daysInMonth; i++) {
      ...
      html += '<button type="button" class="' + cls + '" data-open-date="' + dateStr + '">' + i + "</button>";
    }
    grid.innerHTML = html;
  ...
  function onDocClick(e) {
    if (e.target.closest(".wp-global-slot")) {
      ...
      if (toggle) {
        ...
        state.expandedId = state.expandedId === nid ? null : nid;
        markRead(nid);
        renderNotiPanel();
        updateNotiBadges();
        return;
