-- ============================================================
-- WePlaNet 전체 DB 스키마 (통합본)
-- ------------------------------------------------------------
-- 생성일: 2026-09-02
-- 기준: main 브랜치가 정상 기동하는 로컬 DB에서 추출 (테이블 44개)
--
-- [이 파일 하나로 두 가지가 다 됩니다]
--   1) 처음 세팅하는 사람: 그냥 전체 실행하면 스키마가 만들어집니다.
--   2) 이미 DB가 있는 사람: 모든 CREATE 문이 IF NOT EXISTS 라서 다시 실행해도
--      안전합니다. 빠진 테이블만 새로 생성됩니다.
--      단, 이미 있는 테이블의 컬럼은 건드리지 않으므로 파일 맨 끝의
--      [부록] 컬럼 마이그레이션 절도 함께 실행하세요.
--
-- [실행 방법]
--   mysql -uroot -p --default-character-set=utf8mb4 weplanet < docs/weplanet_schema.sql
--   또는 Workbench / DataGrip 에서 파일 열고 전체 실행
--
-- [주의]
--   ddl-auto=validate 설정이라 엔티티에 있는 테이블이나 컬럼이 DB에 없으면
--   서버가 아예 기동되지 않습니다. pull 후 서버가 안 뜨면 이 파일부터 실행해 보세요.
--
--   데이터는 포함돼 있지 않습니다. 구조만 만듭니다.
-- ============================================================
...
-- ------------------------------------------------------------
-- 테이블 정의 (알파벳 순, FK 때문에 순서 무관하도록 FK 체크를 꺼둠)
-- ------------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='소속사 마스터';
...
CREATE TABLE IF NOT EXISTS `artist_group_profiles` (
  ...
  `artist_id` bigint NOT NULL COMMENT '아티스트(users.id)',
  `gender` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '그룹/아티스트 성별(탐색 필터)',
  `member_count` int DEFAULT NULL COMMENT '구성 인원 수(탐색 필터)',
  `nationality` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '국적(탐색 필터)',
  `category` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '직업/카테고리(탐색 필터)',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='아티스트 그룹/커뮤니티';
...
CREATE TABLE IF NOT EXISTS `community_profiles` (
  ...
  `nickname` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '해당 커뮤니티 전용 닉네임',
  `bio` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '짧은 소개',
  `avatar_stored_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '아바타 저장 파일명',
  `background_stored_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '배경 이미지 저장 파일명',
...
CREATE TABLE IF NOT EXISTS `fan_badge` (
  ...
  `badge_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '배지 코드(전체 고유)',
  `badge_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '배지 표시명',
  `badge_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '배지 유형: BASIC/SPECIAL',
  `icon` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 0xF09F8F85 COMMENT '표시용 이모지',
  `image_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '배지 이미지 경로. 있으면 이미지, 없으면 icon 이모지로 표시',
  `description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '획득 조건 안내 문구',
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='배지 카탈로그(전 아티스트 공통)';
CREATE TABLE IF NOT EXISTS `fan_badge_ownership` (
  ...
  `badge_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '배지 코드(fan_badge.badge_code)',
  `badge_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '수여 시점 배지명 스냅샷',
  `badge_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '배지 유형: BASIC/SPECIAL',
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='팬 배지 보유/회수';
CREATE TABLE IF NOT EXISTS `fan_project` (
  ...
  `title` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '프로젝트 제목',
  `event_type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '이벤트 유형: BIRTHDAY_CAFE/BILLBOARD/CONCERT/ETC',
  ...
  `description` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '프로젝트 소개',
  `status` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING_APPROVAL' COMMENT '상태: 승인대기/승인/반려/모금중 등',
  ...
  `eligibility_rule_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SPECIAL_1_AND_BASIC_5' COMMENT '개설 자격 규칙 코드',
  `identity_verification_method` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'EMAIL' COMMENT '프로젝트 등록 인증 방식(EMAIL)',
  ...
  `rejection_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '반려 사유(REJECTED 시)',
  `created_at` datetime(6) NOT NULL COMMENT '등록 시각',
  `updated_at` datetime(6) NOT NULL COMMENT '수정 시각',
  `deleted_at` datetime(6) DEFAULT NULL COMMENT '삭제(soft delete) 시각',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `fan_project_contribution` (
  ...
  `order_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '주문번호',
  `idempotency_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '결제 멱등 키(중복요청 방지)',
  `payment_provider` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'MOCK' COMMENT '결제 제공자',
  `provider_transaction_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '제공자 거래 ID',
  ...
  `payment_status` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'READY' COMMENT '결제 상태: READY/PAID/FAILED 등',
  ...
  `refund_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '환불 사유',
  `created_at` datetime(6) NOT NULL COMMENT '생성 시각',
  `updated_at` datetime(6) NOT NULL COMMENT '수정 시각',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `fan_project_cover_image` (
  ...
  `stored_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '서버 저장 파일명',
  `content_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'MIME(image/*)',
...
CREATE TABLE IF NOT EXISTS `fan_project_fraud_check` (
  ...
  `project_id` bigint NOT NULL COMMENT '프로젝트(fan_project.id)',
  `target_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '조회 대상: ACCOUNT',
  `target_fingerprint` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '대상 식별 해시',
  `bank_code` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '은행코드(계좌 조회 시)',
  `provider` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'THECHEAT' COMMENT '조회 제공자',
  `provider_result_code` int DEFAULT NULL COMMENT '제공자 결과 코드',
  `result_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING' COMMENT '결과: PENDING/CLEAR/CAUTION/ERROR',
  `caution_yn` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '주의 여부 Y/N',
...
CREATE TABLE IF NOT EXISTS `fan_project_settlement_account` (
  ...
  `project_id` bigint NOT NULL COMMENT '프로젝트(fan_project.id) 1:1',
  `bank_code` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '은행코드(3자리)',
  `account_number_enc` varbinary(512) NOT NULL COMMENT '계좌번호(암호화)',
  `account_number_hmac` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '계좌번호 HMAC(검색용)',
  `account_number_last4` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '계좌 끝 4자리(표시용)',
  `verification_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'UNVERIFIED' COMMENT '계좌 검증: UNVERIFIED/VERIFIED/FAILED',
...
CREATE TABLE IF NOT EXISTS `post` (
  ...
  `link_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '첨부 링크 URL',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='공통 회원 계정';
...
-- ============================================================
-- [부록] 컬럼 마이그레이션 (이미 DB가 있는 사람만)
-- ------------------------------------------------------------
-- 위 CREATE 문은 IF NOT EXISTS 라서 기존 테이블에는 컬럼을 추가하지 못합니다.
-- 최근에 추가된 컬럼만 아래에 모아뒀습니다. 여러 번 실행해도 안전하며,
-- 이미 반영돼 있으면 SKIP 메시지만 나옵니다.
-- ============================================================

-- CHAT-02 비대칭 수신: 전송 시점의 노출 판정을 저장 SET @x := (SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE()              AND TABLE_NAME = 'chat_message' AND COLUMN_NAME = 'visible_to_artist'); SET @ddl := IF(@x = 0, 'ALTER TABLE chat_message ADD COLUMN visible_to_artist TINYINT(1) NOT NULL DEFAULT 1',   'SELECT ''SKIP: chat_message.visible_to_artist'' AS migration'); PREPARE stmt FROM @ddl; EXECUTE stmt; DEALLOCATE PREPARE stmt; 
-- PROFILE: 커뮤니티 프로필 내용 숨김 SET @x := (SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE()              AND TABLE_NAME = 'community_profiles' AND COLUMN_NAME = 'content_hidden'); SET @ddl := IF(@x = 0, 'ALTER TABLE community_profiles ADD COLUMN content_hidden TINYINT(1) NOT NULL DEFAULT 0',   'SELECT ''SKIP: community_profiles.content_hidden'' AS migration'); PREPARE stmt FROM @ddl; EXECUTE stmt; DEALLOCATE PREPARE stmt; 
-- NOTICE-01: 공지 상단 고정 SET @x := (SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE()              AND TABLE_NAME = 'portal_notice' AND COLUMN_NAME = 'pinned'); SET @ddl := IF(@x = 0, 'ALTER TABLE portal_notice ADD COLUMN pinned BIT(1) NOT NULL DEFAULT 0 AFTER published',   'SELECT ''SKIP: portal_notice.pinned'' AS migration'); PREPARE stmt FROM @ddl; EXECUTE stmt; DEALLOCATE PREPARE stmt; 
-- NOTICE-01: 공지 고정 순서 SET @x := (SELECT COUNT(*) FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE()              AND TABLE_NAME = 'portal_notice' AND COLUMN_NAME = 'pin_order'); SET @ddl := IF(@x = 0, 'ALTER TABLE portal_notice ADD COLUMN pin_order INT DEFAULT NULL AFTER pinned',   'SELECT ''SKIP: portal_notice.pin_order'' AS migration'); PREPARE stmt FROM @ddl; EXECUTE stmt; DEALLOCATE PREPARE stmt; 
-- ------------------------------------------------------------
